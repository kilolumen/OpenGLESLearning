...
/// @param[in] frontStickerRotate 前景贴纸朝向, 0代表106/107点在上, 90代表106/107点在左, 180代表106/107点在下, 270代表106/107点在右
...
st_mobile_sticker_process_texture(
    ...
    st_rotate_type rotate, st_rotate_type frontStickerRotate, bool need_mirror,
