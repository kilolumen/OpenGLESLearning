...
void main(void)
{
    ...
    finalColor += texture2D(texture0, uv_0) * -1.0;
    ...
    finalColor += texture2D(texture0, uv_2) * -1.0;
    ...
    finalColor += texture2D(texture0, uv_4) * 9.0;
    ...
    finalColor += texture2D(texture0, uv_6) * -1.0;
    ...
    finalColor += texture2D(texture0, uv_8) * -1.0;
