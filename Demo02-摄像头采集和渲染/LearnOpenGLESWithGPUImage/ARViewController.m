...
@property (nonatomic, strong) NSMutableDictionary<ARAnchor *, GLObject *> * objects;
@property (nonatomic, assign) GLKVector3 lightDirection;
@property (nonatomic, strong) FeaturePointCloud *pointCloud;
...
- (void)createPointCloud
{
    ...
    NSString *fragmentShaderPath = [[NSBundle mainBundle] pathForResource:@"frag_point_cloud" ofType:@".glsl"];
...
- (void)handlTap:(UIGestureRecognizer *)gesture
{
    ARFrame *currentFrame = [self.arSession currentFrame];
    
    CGPoint point = [gesture locationInView:gesture.view];
    NSArray<ARHitTestResult *> *results = [currentFrame hitTest:CGPointMake(point.x/gesture.view.frame.size.width, point.y/gesture.view.frame.size.height) types:ARHitTestResultTypeExistingPlaneUsingExtent];
